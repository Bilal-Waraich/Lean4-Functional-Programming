-- Extracted from hw04 — Monadic parser combinator library: Parser monad instance, combinators (many, choice, constrain), and parsers for natural numbers and arithmetic expressions
